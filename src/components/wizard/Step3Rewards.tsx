...
import { step3Schema, Step3Data, rewardTypes, giftProducts } from "@/lib/promotionSchema";
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-4">
            {fields.map((field, index) => (
              <Card key={field.id} className="border-border hover:border-brand-teal/40 transition-colors">
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <FormField
                      ...
                      render={({ field: valueField }) => {
                        ...
                        return (
                          <FormItem className="flex-1">
                            <FormLabel className="text-text-dark font-medium">Valor</FormLabel>
                            <FormControl>
                              <Input
                                placeholder="Valor"
